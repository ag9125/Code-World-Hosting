...
export default function Sidebar() {
  ...
  // For small screen dropdown toggle
  ...
  return (
    <>
      ...
      <div className={`md:hidden px-4 py-3 border-b border-richblack-700 ${isDropdownOpen&&'bg-richblack-800  '}`}>
        <button
          onClick={() => setIsDropdownOpen((prev) => !prev)}
          className="w-full text-left text-richblack-100 font-semibold"
        >
          ☰ 
        </button>
      </div>
      ...
      {isDropdownOpen && (
        <div className="md:hidden bg-richblack-800 border-b border-richblack-700 px-4 py-2 space-y-2 w-full">
